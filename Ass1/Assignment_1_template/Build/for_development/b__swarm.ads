...
package ada_main is
   ...
   u00374 : constant Version_32 := 16#de9d38be#;
   ...
   u00378 : constant Version_32 := 16#3f9810f0#;
   ...
   u00383 : constant Version_32 := 16#20716954#;
   pragma Export (C, u00383, "vehicle_message_typeB");
   u00384 : constant Version_32 := 16#778b691a#;
   pragma Export (C, u00384, "vehicle_message_typeS");
   u00385 : constant Version_32 := 16#8460594d#;
   pragma Export (C, u00385, "shared_message_structureS");
   u00386 : constant Version_32 := 16#7162da91#;
   pragma Export (C, u00386, "vehicle_task_typeB");
   u00387 : constant Version_32 := 16#58fd0c20#;
   pragma Export (C, u00387, "vehicle_task_typeS");
   u00388 : constant Version_32 := 16#fd2ad2f1#;
   pragma Export (C, u00388, "gnatS");
   u00389 : constant Version_32 := 16#b48102f5#;
   pragma Export (C, u00389, "gnat__ioB");
   u00390 : constant Version_32 := 16#6227e843#;
   pragma Export (C, u00390, "gnat__ioS");
   ...
   u00395 : constant Version_32 := 16#8b793e78#;
   pragma Export (C, u00395, "vehicle_interfaceS");
   u00396 : constant Version_32 := 16#87654eb5#;
   pragma Export (C, u00396, "system__tasking__async_delaysB");
   u00397 : constant Version_32 := 16#47f015f3#;
   pragma Export (C, u00397, "system__tasking__async_delaysS");
   u00398 : constant Version_32 := 16#3a39a0f4#;
   pragma Export (C, u00398, "system__interrupt_management__operationsB");
   u00399 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00399, "system__interrupt_management__operationsS");
   u00400 : constant Version_32 := 16#a6d7988d#;
   pragma Export (C, u00400, "vectors_3d_lfB");
   u00401 : constant Version_32 := 16#abff4c19#;
   pragma Export (C, u00401, "vectors_3d_lfS");
   u00402 : constant Version_32 := 16#1e27852c#;
   pragma Export (C, u00402, "vectors_conversionsB");
   u00403 : constant Version_32 := 16#923ddf49#;
   pragma Export (C, u00403, "vectors_conversionsS");
   u00404 : constant Version_32 := 16#cdecf3e0#;
   pragma Export (C, u00404, "vectors_2dS");
   u00405 : constant Version_32 := 16#3b68dc9f#;
   pragma Export (C, u00405, "vectors_2d_iS");
   u00406 : constant Version_32 := 16#e9217b79#;
   pragma Export (C, u00406, "vectors_2d_pS");
   u00407 : constant Version_32 := 16#878e5819#;
   pragma Export (C, u00407, "swarm_control_concurrent_genericB");
   u00408 : constant Version_32 := 16#7d3a30dd#;
   pragma Export (C, u00408, "swarm_control_concurrent_genericS");
